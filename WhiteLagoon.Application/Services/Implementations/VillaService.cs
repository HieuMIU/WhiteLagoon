...
namespace WhiteLagoon.Application.Services.Implementations
{
    public class VillaService : IVillaService
    {
        ...
        public bool DeleteVilla(int id)
        {
            try
            {
                Villa? objFromDb = GetVillaById(id);
        ...
        {
            return _unitOfWork.Villa.Get(u => u.Id == id, includeProperties);
        }
        ...
        public bool IsVillaAvailableByDate(int villaId, int nights, DateOnly checkInDate)
        {
            ...
            return SD.VillaRoomsAvailable_Count(villaId, villaNumbersList, checkInDate, nights, bookedVillas) > 0;           
        }
